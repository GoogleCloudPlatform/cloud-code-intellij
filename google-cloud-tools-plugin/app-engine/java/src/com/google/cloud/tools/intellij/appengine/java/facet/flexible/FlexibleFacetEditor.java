...
import com.google.cloud.tools.intellij.appengine.java.cloud.flexible.FileConfirmationDialog.DialogType;
import com.google.cloud.tools.intellij.appengine.java.cloud.flexible.SelectConfigDestinationFolderDialog;
...
public class FlexibleFacetEditor extends FacetEditorTab {
  ...
  FlexibleFacetEditor(
    ...
    appYamlField.addBrowseFolderListener(
        AppEngineMessageBundle.message("appengine.flex.config.browse.app.yaml"),
        null /* description */,
        module.getProject(),
    ...
    dockerDirectoryField.addBrowseFolderListener(
        AppEngineMessageBundle.message("appengine.flex.config.browse.docker.directory"),
        null /* description */,
        module.getProject(),
  ...
  private void toggleInvalidDockerfileState(String message) {
    ...
    dockerfileErrorMessage.setHyperlinkText(
        message,
        AppEngineMessageBundle.message("appengine.flex.facet.config.dockerfile.generate.link.text"),
        "");
  }
  ...
  private boolean validateAndWarnFileGeneration(
    ...
    if (Files.exists(destinationFilePath)) {
      Messages.showErrorDialog(
          ...
          AppEngineMessageBundle.message("appengine.flex.config.generation.error.title"));
      return false;
