...
public class ProjectLoader {
  ...
  void loadUserProjectsInBackground(CredentialedUser user, ProjectLoaderResultCallback resultCallback) {
  ...
  @VisibleForTesting
  CloudResourceManager createCloudResourceManager(CredentialedUser user) {
    return
