...
public class ApiNamespaceInspection extends EndpointInspectionBase {
  ...
  public PsiElementVisitor buildVisitor(
    ...
    return new EndpointPsiElementVisitor() {
      ...
      public void visitAnnotation(PsiAnnotation annotation) {
        ...
        if (!GctConstants.APP_ENGINE_ANNOTATION_API_NAMESPACE
        ...
        if (!allUnspecified && !ownerFullySpecified) {
          holder
              .registerProblem(annotation, "Invalid namespace configuration. If a namespace is set,"
  ...
  public class MyQuickFix implements LocalQuickFix {
    ...
    private void addOwnerDomainAttribute(@NotNull final Project project,
        ...
        protected void run(final Result result) throws Throwable {
          ...
          PsiAnnotationMemberValue newMemberValue = JavaPsiFacade.getInstance(project)
              ...
              .createAnnotationFromText(
                  "@A(" + API_NAMESPACE_DOMAIN_ATTRIBUTE + " = \"" + SUGGESTED_DOMAIN_ATTRIBUTE
                      + "\")", null).findDeclaredAttributeValue(API_NAMESPACE_DOMAIN_ATTRIBUTE);
    ...
    private void addOwnerNameAttribute(@NotNull final Project project,
        final PsiAnnotation annotation) {
      new WriteCommandAction(project, annotation.getContainingFile()) {
        @Override
        protected void run(final Result result) throws Throwable {
          ...
          PsiAnnotationMemberValue newMemberValue = JavaPsiFacade.getInstance(project)
              .getElementFactory()
              .createAnnotationFromText(
                  "@A(" + API_NAMESPACE_NAME_ATTRIBUTE + " = \"" + SUGGESTED_OWNER_ATTRIBUTE
                      + "\")", null).findDeclaredAttributeValue(API_NAMESPACE_NAME_ATTRIBUTE);
    ...
    private void addOwnerDomainAndNameAttributes(@NotNull final Project project,
        final PsiAnnotation annotation) {
      new WriteCommandAction(project, annotation.getContainingFile()) {
        @Override
        protected void run(final Result result) throws Throwable {
          ...
          String annotationString = "@A(" + API_NAMESPACE_NAME_ATTRIBUTE + " = \""
              + SUGGESTED_OWNER_ATTRIBUTE + "\", " + API_NAMESPACE_DOMAIN_ATTRIBUTE + " = \""
              + "your-company.com" + "\")";
          ...
          PsiAnnotationMemberValue newDomainMemberValue = newAnnotation
              .findDeclaredAttributeValue(API_NAMESPACE_DOMAIN_ATTRIBUTE);
          PsiAnnotationMemberValue newNameMemberValue = newAnnotation
          ...
          annotation
              .setDeclaredAttributeValue(API_NAMESPACE_DOMAIN_ATTRIBUTE, newDomainMemberValue);
        }
      }.execute();
    }
  }
