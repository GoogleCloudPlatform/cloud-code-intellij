 ...
 */
public class CloudSdkRunSettingsEditor extends SettingsEditor<RunConfiguration> {
  ...
  @Override
  protected void applyEditorTo(RunConfiguration configuration) throws ConfigurationException {
