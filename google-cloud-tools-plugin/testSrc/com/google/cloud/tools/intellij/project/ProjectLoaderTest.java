...
public class ProjectLoaderTest {
  ...
  @TestService
  @Mock private GoogleApiClientFactory mockGoogleApiClientFactory;
  ...
  @Test
  public void getProjectList_triggersCallback() {
    List<Project> projects = Arrays.asList(testProject1, testProject2);
    mockListProjectsResponse(projects);
    projectLoader.loadUserProjects(mockUser, mockResultCallback);
