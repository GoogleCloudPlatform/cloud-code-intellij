...
public class FilteredTextTableCellRendererTest {
  private static final String SAMPLE_TEXT = "your project name.";
  ...
  public void highlights_matchingText() {
    ...
    String expected = "<html>your <b>project</b> name.";
  ...
  public void highlights_matchingText_atStart() {
    ...
    String expected = "<html><b>you</b>r project name.";
  ...
  public void highlights_matchingText_atEnd() {
    String result = renderer.highlightFilterText("me.", SAMPLE_TEXT);
    String expected = "<html>your project na<b>me.</b>";
