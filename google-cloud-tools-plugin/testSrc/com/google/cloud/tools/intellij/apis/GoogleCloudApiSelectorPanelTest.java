...
public final class GoogleCloudApiSelectorPanelTest {
  ...
  public void getPanel_withVersionReturnedFromBomQuery_displaysVersionFromBom() {
    ...
    panel
        .getDetailsPanel()
        .setCloudLibrary(
            cloudLibrary, BOM_VERSION, panel.getApiManagementMap().get(cloudLibrary));
  ...
  public void
    ...
    panel
        .getDetailsPanel()
        .setCloudLibrary(library1, BOM_VERSION, apiManagementMap.get(library1));
    checkEnableCheckbox(panel.getDetailsPanel().getEnableApiCheckbox(), false);

    panel
        .getDetailsPanel()
        .setCloudLibrary(library2, BOM_VERSION, apiManagementMap.get(library2));
    checkEnableCheckbox(panel.getDetailsPanel().getEnableApiCheckbox(), false);
  ...
  public void getManagementUI_withLibraryAndProjectUnselected_isDisabled() {
    ...
    panel
        .getDetailsPanel()
        .setCloudLibrary(
            library, BOM_VERSION, panel.getApiManagementMap().get(library));
  ...
  public void getEnableCheckbox_withNoLibrarySelected_isNotSelected() {
    ...
    panel
        .getDetailsPanel()
        .setCloudLibrary(library, BOM_VERSION, apiManagementMap.get(library));
