...
public class AppEngineFlexibleStageTest extends PlatformTestCase {
  ...
  public void testStage_noYaml() {
    ...
    try {
      ...
      assertEquals("Error occurred during App Engine flexible staging: the specified app.yaml "
          + "configuration file does not exist or is not a valid file.", re.getMessage());
    }
  }
  ...
  public void testStage_noDockerDirectory() {
    ...
    try {
      ...
      assertEquals("Error occured during App Engine flexible staging: there is no Dockerfile in "
          + "specified directory.", re.getMessage());
    }
  }
  ...
  public void testStage_noModule() {
    ...
    try {
      ...
      assertEquals("Error occurred during App Engine flexible staging: no app.yaml configuration "
          + "file was specified.", re.getMessage());
    }
  }
