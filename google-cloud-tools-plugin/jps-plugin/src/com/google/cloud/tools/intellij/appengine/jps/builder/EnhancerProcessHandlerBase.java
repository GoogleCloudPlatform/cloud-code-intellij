...
public abstract class EnhancerProcessHandlerBase extends BaseOSProcessHandler {
  ...
  private static final Logger LOG = Logger
      .getInstance("#com.intellij.appengine.enhancement.EnhancerProcessHandler");
  private FactoryMap<Key, EnhancerOutputParser> myParsers
      = new FactoryMap<Key, EnhancerOutputParser>() {
        @Override
  ...
  private class EnhancerOutputParser {
    ...
    public void appendText(String text) {
      ...
      while (true) {
        ...
        int lineEnd =
            lineEnd1 == -1 ? lineEnd2 : lineEnd2 == -1 ? lineEnd1 : Math.min(lineEnd1, lineEnd2);
