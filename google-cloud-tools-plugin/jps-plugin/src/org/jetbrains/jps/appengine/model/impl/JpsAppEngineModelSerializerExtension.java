...
public class JpsAppEngineModelSerializerExtension extends JpsModelSerializerExtension {
  ...
  private static class JpsAppEngineModuleExtensionSerializer extends
      JpsFacetConfigurationSerializer<JpsAppEngineModuleExtension> {
    ...
    protected JpsAppEngineModuleExtension loadExtension(@NotNull Element facetConfigurationElement,
        ...
        JpsElement parent,
        JpsModule module) {
      AppEngineModuleExtensionProperties properties = XmlSerializer
          .deserialize(facetConfigurationElement, AppEngineModuleExtensionProperties.class);
      return new JpsAppEngineModuleExtensionImpl(
          properties != null ? properties : new AppEngineModuleExtensionProperties());
    }

    @Override
    protected void saveExtension(JpsAppEngineModuleExtension extension,
        Element facetConfigurationTag, JpsModule module) {
      XmlSerializer.serializeInto(((JpsAppEngineModuleExtensionImpl) extension).getProperties(),
