...
### Added
  - Let the Google Cloud Tools plugin manage, install, and update the Google Cloud SDK for you. No longer any need to manually download the SDK. [673](https://github.com/GoogleCloudPlatform/google-cloud-intellij/issues/673)
