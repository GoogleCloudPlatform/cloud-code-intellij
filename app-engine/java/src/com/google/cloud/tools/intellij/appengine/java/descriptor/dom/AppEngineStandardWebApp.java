...
package com.google.cloud.tools.intellij.appengine.java.descriptor.dom;
...
public interface AppEngineStandardWebApp extends DomElement {
  ...
  /**
   * Returns the 'runtime' type of the application. For Java this is primarily empty for Java 7 and
   * 'java8' for Java 8.
   */
  GenericDomValue<String> getRuntime();
