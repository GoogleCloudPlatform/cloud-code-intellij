...
/** Gradle-specific extension of {@link AppEngineStandardLibraryManager}. */
public class AppEngineStandardGradleLibraryManager implements AppEngineStandardLibraryManager {

  /**
   * Returns {@code false} if the module is a gradle module, and {@code true} otherwise.
   *
