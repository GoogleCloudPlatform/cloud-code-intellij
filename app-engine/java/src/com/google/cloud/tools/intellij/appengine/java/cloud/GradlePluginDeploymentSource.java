...
/**
 * An app-gradle-plugin based {@link ModuleDeploymentSource}. Provides the path to the Gradle
 * exploded war directory generated by the App Engine Gradle plugin and stored in the App Engine
 * Gradle facet.
 */
