...
package com.google.kubernetes.tools.skaffold.metrics

const val SKAFFOLD_DEV_RUN_SUCCESS = "skaffold.dev.run"
const val SKAFFOLD_DEV_RUN_FAIL = "skaffold.dev.run.fail"
