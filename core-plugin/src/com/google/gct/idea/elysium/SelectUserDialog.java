...
/**
 * A dialog that prompts the user to select a {@link GoogleLogin} or click "Login Manually" to continue without {@link
...
// DO NOT EDIT OR ADD ANY CODE HERE!
  ...
  private void $$$setupUI$$$() {
    ...
    this.$$$loadLabelText$$$(label1,
        ResourceBundle.getBundle("messages/CloudToolsBundle").getString("select.user.login"));
    ...
    myLogin = new UserSelector();
    myRootPanel.add(myLogin,
