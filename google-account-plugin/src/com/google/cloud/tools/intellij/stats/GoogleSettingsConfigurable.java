...
public class GoogleSettingsConfigurable implements SearchableConfigurable {
  ...
  private JPanel creatUsageTrackerComponent() {
    enableUsageTrackerBox = new JCheckBox(
        TrackerMessageBundle.message("settings.enable.tracker.text"));
    enableUsageTrackerBox.setSelected(usageTrackerManager.hasUserOptedIn());
    ...
    usageTrackerGroup
        .setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED), "Usage Tracker"));
